...
function handleBackgroundImg(){
  if(window.innerWidth >= 768 && window.innerWidth < 1440){
    bgImg.setAttribute("src", "/space-tourism-website/starter-code/assets/crew/background-crew-tablet.jpg");
  }
  else if(window.innerWidth >= 1440){
    bgImg.setAttribute("src", "/space-tourism-website/starter-code/assets/crew/background-crew-desktop.jpg");
  }
  else if(window.innerWidth < 768){
    bgImg.setAttribute("src", "/space-tourism-website/starter-code/assets/crew/background-crew-mobile.jpg");
  }
}
