...
function handleBackgroundImg(){
  if(window.innerWidth >= 768 && window.innerWidth < 1440){
    bgImg.setAttribute("src", "/space-tourism-website/starter-code/assets/destination/background-destination-tablet.jpg");
  }
  else if(window.innerWidth >= 1440){
    bgImg.setAttribute("src", "/space-tourism-website/starter-code/assets/destination/background-destination-desktop.jpg");
  }
  else if(window.innerWidth < 768){
    bgImg.setAttribute("src", "/space-tourism-website/starter-code/assets/destination/background-destination-mobile.jpg");
  }
}
